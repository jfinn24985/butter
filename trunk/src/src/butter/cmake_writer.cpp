 ...
 */
const QString cmake_writer::build_file_name("CMakeLists.txt");

/**
 * The default leaf filename for the current style
 */
const QString& cmake_writer::build_file_sysname(cmake_writer::build_file_name);

/**
 * Identify the minimum cmake version this generator supports.
 */
const QString cmake_writer::cmake_minimum_required_("cmake_minimum_required(VERSION 2.6)");

/**
 * Comment line prefix
 */
const QString cmake_writer::comment_string("#");

const QString cmake_writer::end_phrase("##END:");

const QString cmake_writer::start_phrase("##START:");

/**
 * The label for description 'sections' and the value of 
 * the style for this buildfile type.
 */
const QString cmake_writer::section_name("cmake");
 ...
 * using this string.
 */
const char * cmake_writer::default_rules[] = { "#\n"
, "# local.cmake\n"
, "#\n"
 ...
 */
const QString cmake_writer::rules_name("local.cmake");

void cmake_writer::assoc_library(const ::UmlArtifact & a_target, QTextStream & a_os, QString & a_includes, QString & a_ldflags, QString & a_cflags) {
////////////////////////////////////
...
void cmake_writer::assoc_source(const ::UmlArtifact & a_target, QTextStream & a_os, QString a_filename, QString a_basename, QString a_src_inc, QString a_src_flags, bool a_isdoc) {
////////////////////////////////////
// Define the associations of target
//
...
std::auto_ptr< build_writer > cmake_writer::create()

{
  std::auto_ptr< build_writer > Result (new cmake_writer);
  return Result;
}

void cmake_writer::descendent_link(compound_artifact & a_art, compound_artifact & a_sys, const location & a_loc) 
{
...
void cmake_writer::end_target(const ::UmlArtifact & a_target, QTextStream & a_os, QString a_include, QString a_ldflags, QString a_cflags, QString a_compiler, build_writer::target_type a_type) {
////////////////////////////////
...
void cmake_writer::initialise(location & a_base, const ::UmlItem & a_project, compound_artifact & a_sys) 
{
...
void cmake_writer::install_target(const ::UmlArtifact & a_target, QTextStream & a_os, QString a_loc_var, build_writer::install_type a_type, bool a_isdoc) 
{
...
QString cmake_writer::mangle(QString input) 
{
const char dollar_('$');
const char escape_('\\');
...
void cmake_writer::start_target(const ::UmlArtifact & a_target, QTextStream & a_os, QString a_build_file, QString a_compiler, build_writer::target_type a_type) {
/////////////////
