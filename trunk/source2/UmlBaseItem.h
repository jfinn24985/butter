...
class UmlBaseItem {
  public:
    ...
    const Q3Dict<QByteArray> properties();
  ...
  friend class UmlBasePort;
  friend class UmlBaseRolePart;
  friend class UmlBaseRolePartInstance;
  friend class UmlBasePortRef;
  friend class UmlBaseConnector;
  friend class UmlBaseClassCompositeDiagram;
  friend class UmlBaseObjectCompositeDiagram;
  friend class UmlBaseVariable;
  friend class UmlBaseStartObjectBehaviorAction;
  friend class UmlBaseReadSelfAction;
  friend class UmlBaseReadExtentAction;
  friend class UmlBaseReclassifyObjectAction;
  friend class UmlBaseReadIsClassifiedObjectAction;
  friend class UmlBaseStartClassifierBehaviorAction;
  friend class UmlBaseStructuralFeatureAction;
  friend class UmlBaseReadStructuralFeatureAction;
  friend class UmlBaseClearStructuralFeatureAction;
  friend class UmlBaseAddStructuralFeatureValueAction;
  friend class UmlBaseRemoveStructuralFeatureValueAction;
};
