...
class UmlCom {
  ...
  public:
    ...
    static void send_cmd(CmdFamily f, unsigned int cmd, const QByteArray & s) {
    ...
    static void send_cmd(CmdFamily f, unsigned int cmd, const QByteArray & s, const QByteArray & v) {
      send_cmd(f, cmd, (const char *) s, (const char *) v);
    }

    //internal, do NOT use it
    
    static void send_cmd(CmdFamily f, unsigned int cmd, const char * s, const QByteArray & v) {
      send_cmd(f, cmd, s, (const char *) v);
    }

    //internal, do NOT use it
    
    static void send_cmd(CmdFamily f, unsigned int cmd, const QByteArray & s, const char * v) {
      send_cmd(f, cmd, (const char *) s, v);
    }
    ...
    static void send_cmd(const void * id, OnInstanceCmd cmd, const QByteArray & arg) {
    ...
    static void send_cmd(const void * id, OnInstanceCmd cmd, const QByteArray & arg1, const QByteArray & arg2) {
    ...
    static void send_cmd(const void * id, OnInstanceCmd cmd, unsigned int arg1, char arg2, const char * arg3, const char * arg4, const UmlTypeSpec & arg5, const char * arg6);
    //internal, do NOT use it
