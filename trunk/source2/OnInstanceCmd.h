...
enum OnInstanceCmd {
  ...
  setActiveCmd,
  setPhpNamespaceCmd,
  setIsLocallyReentrantCmd,
  setIsCppThreadLocalCmd,
  setIsCppDeletedCmd,
  setIsCppDefaultedCmd,
  setIsCppConstExprCmd,
  setIsCppOverrideCmd,
  setIsCppFinalCmd,
  setIsCppNoexceptCmd,
  setMysqlDeclCmd,
  setMysqlSrcCmd,
  setMysqlDirCmd,
  setMysqlConstraintCmd,
  setMysqlColumnsCmd,
  setMysqlReferencedKeyCmd,
  setMysqlOnDeleteCmd,
  setMysqlOnUpdateCmd,
  setMysqlKindCmd,
  setIsMysqlNotNullHashCmd,
  setIsMysqlAutoIncrBtreeCmd,
  setJavaDefaultOperCmd,
  setIsJavaStaticCmd,
  setIsConjugatedCmd,
  setIsServiceCmd,
  setProtocolCmd,
