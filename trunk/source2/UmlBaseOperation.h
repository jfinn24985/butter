...
class UmlBaseOperation : public UmlClassMember {
  public:
    ...
    bool isCppVolatileValue();

    //if the operation value is declared volatile in C++
    //
    // On error return FALSE in C++, produce a RuntimeException in Java
    bool set_isCppVolatileValue(bool v);

    // return if the operation value is declared const in C++
    bool isCppConstValue();

    //if the operation value is declared const in C++
    //
    // On error return FALSE in C++, produce a RuntimeException in Java
    bool set_isCppConstValue(bool v);

    // return if the operation value is declared const in C++
    bool isCppConstExprValue();

    //if the operation value is declared const in C++
    //
    // On error return FALSE in C++, produce a RuntimeException in Java
    bool set_isCppConstExprValue(bool v);
    ...
    //
    // On error : return FALSE in C++, produce a RuntimeException in Java
    bool set_isCppDefaulted(bool y);
  ...
  private:
    ...
    bool _cpp_volatilevalue : 1;

    bool _cpp_constvalue : 1;

    bool _cpp_constexprvalue : 1;
    ...
    bool _cpp_noexcept : 1;

    bool _cpp_deleted : 1;

    bool _cpp_defaulted : 1;
