...
class CppSettings : public UmlSettings {
  public:
    ...
    // reversed in C++
    static QByteArray headerAdditionalExtensions();

    // set the additional extensions of the header files
    // reversed in C++
    //
    // On error : return FALSE in C++, produce a RuntimeException in Java
    static bool set_HeaderAdditionalExtensions(QByteArray v);
    ...
    // reversed in C++
    static QByteArray sourceAdditionalExtensions();

    // set the additional extensions of the source files
    // reversed in C++
    //
    // On error : return FALSE in C++, produce a RuntimeException in Java
    static bool set_SourceAdditionalExtensions(QByteArray v);
    ...
    static const QByteArray & friendClassIndent();

    // set friend class declaration indent
    //
    // On error : return FALSE in C++, produce a RuntimeException in Java
    static bool set_FriendClassIndent(QByteArray v);

    // return the indent of the nested class declaration
    
    static const QByteArray & nestedClassIndent();

    // set nested class declaration indent
    //
    // On error : return FALSE in C++, produce a RuntimeException in Java
    static bool set_NestedClassIndent(QByteArray v);
    ...
    static const QByteArray & enumClassDecl();

    // set the default definition of an enum class
    //
    // On error : return FALSE in C++, produce a RuntimeException in Java
    static bool set_EnumClassDecl(QByteArray v);
    ...
    static const QByteArray & templateTypedefDecl();

    // set the default definition of a template typedef
    //
    // On error : return FALSE in C++, produce a RuntimeException in Java
    static bool set_TemplateTypedefDecl(QByteArray v);
    ...
    //
    // On error : return FALSE in C++, produce a RuntimeException in Java
    static bool set_RelationDecl(bool composition, const char * multiplicity, const char * v);
    ...
    // when the operations does not have exception
    static bool operationForceNoexcept();

    // set if the operations profile must contain 'noexcept'
    // when the operations does not have exception
    //
    // On error : return FALSE in C++, produce a RuntimeException in Java
    static bool set_OperationForceNoexcept(bool y);
    ...
    static bool isTypeUsedByValueForceItsIncludesInHeader();
    ...
    //
    // On error : return FALSE in C++, produce a RuntimeException in Java
    static bool set_isTypeUsedByValueForceItsIncludesInHeader(bool v);
  ...
  private:
    ...
    static QByteArray _enumclass_decl;

    static QByteArray _typedef_decl;

    static QByteArray _template_typedef_decl;
    ...
    static bool _force_oper_noexcept;
    ...
    static QByteArray _h_add_ext;

    static QByteArray _src_ext;

    static QByteArray _src_add_ext;
    ...
    static QByteArray _friendclass_indent;

    static QByteArray _nestedclass_indent;

    static bool _type_by_value_force_its_incl_in_h;

    static Q3Dict<QByteArray> _map_includes;
