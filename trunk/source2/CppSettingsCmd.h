...
enum CppSettingsCmd {
  ...
  setCppIndentFriendClassCmd,
  setCppIndentNestedClassCmd,
  setCppEnumClassDeclCmd,
  setCppTemplateTypedefDeclCmd,
  setCppOperationForceNoexceptCmd,
  setCppTypeUsedByValueForceItsIncludesInHeaderCmd,
  setCppHeaderAdditionalExtensionsCmd,
  setCppSourceAdditionalExtensionsCmd
