#ifndef BUTTER_BASIC_STYLE_H
#define BUTTER_BASIC_STYLE_H
...
class basic_style {
  ...
  public:
    inline basic_style(QString a_com_start, QString a_com_end, QString a_end_phr, QString a_end_end, QString a_start_phr, QString a_start_end, QString a_name, const write_factory_fn_t & a_factory) : comment_string_(a_com_start)
  ...
  public:
    inline const QString & comment_string() const {
          return this->comment_string_;
        };
    inline const QString & end_comment_string() const {
          return this->end_comment_string_;
        };
    inline const QString & end_phrase() const {
          return this->end_phrase_;
        };
    inline const QString & end_end_phrase() const {
          return this->end_end_phrase_;
        };
    inline const QString & end_start_phrase() const {
          return this->end_start_phrase_;
        };
    inline const QString & name() const {
          return this->name_;
        };
    inline const QString & start_phrase() const {
