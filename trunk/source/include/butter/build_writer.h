#ifndef BUTTER_BUILD_WRITER_HPP
#define BUTTER_BUILD_WRITER_HPP
...
/**
 * The build writer derived classes are responsible for creating a set of build system artifacts
