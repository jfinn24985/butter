#ifndef BUTTER_GMAKE_WRITER_HPP
#define BUTTER_GMAKE_WRITER_HPP
 ...
 * \endcond xdoc
 */
class gmake_writer : public writer<gmake_writer> {
...
friend class writer<gmake_writer>;
  ...
  private:
     ...
     * no copy
     */
    gmake_writer(const gmake_writer &);
     ...
     * no assign
     */
    gmake_writer & operator=(const gmake_writer &);
    /**
