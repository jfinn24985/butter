#ifndef BUTTER_JAM_WRITER_HPP
#define BUTTER_JAM_WRITER_HPP
...
/**
 * Build file writer for standard jam.
 * 
 ...
 * \endcond XDOC
 */
class jam_writer : public writer<jam_writer> {
...
friend class writer<jam_writer>;
  ...
  private:
     ...
     * no copy
     */
    jam_writer(const jam_writer &);

    /**
     * no assign
     */
    jam_writer & operator=(const jam_writer &);
    /**
     * ** This method sets up object for creating a new target entry for a_target.
     * 
     * Responsibility
