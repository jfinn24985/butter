...
class PhpSettings : public UmlSettings {
  public:
     ...
     *  On error : return FALSE in C++, produce a RuntimeException in Java
     */
    static bool set_TraitDecl(QByteArray v);
     ...
     *  On error : return FALSE in C++, produce a RuntimeException in Java
     */
    static bool set_IsParametersTyped(bool y);

    /**
     *  returns TRUE if out/inout parameters are given by reference
     */
    static bool isOutInoutParametersByReference();
     ...
     *  On error : return FALSE in C++, produce a RuntimeException in Java
     */
    static bool set_IsOutInoutParametersByReference(bool y);
  ...
  private:
    ...
    static bool _is_param_typed;

    static bool _is_out_inout_by_ref;
