...
atf_test_case extern_lib_jam_gen
extern_lib_jam_gen_head() {
  atf_set "descr" "Test Standard Jam generator on single directory project."
}
extern_lib_jam_gen_body() {
  pushd ../test/extern_lib
  #----------------------- 
  # Standard (jam) variant 
  #-----------------------
  setup_example "extern_lib" "jam"
...
atf_test_case extern_lib_boost_gen
extern_lib_boost_gen_head() {
  atf_set "descr" "Test Boost Jam generator on single directory project."
}
extern_lib_boost_gen_body() {
  pushd ../test/extern_lib
  #-------------- 
  # Boost variant 
  #-------------- 
  setup_example "extern_lib" "boost"
...
atf_test_case extern_lib_cmake_gen
extern_lib_cmake_gen_head() {
  atf_set "descr" "Test CMake generator on single directory project."
}
extern_lib_cmake_gen_body() {
  pushd ../test/extern_lib
  #-------------- 
  # CMake variant 
  #-------------- 
  setup_example "extern_lib" "cmake"
...
atf_test_case extern_lib_make_gen
extern_lib_make_gen_head() {
  atf_set "descr" "Test Makefile generator on single directory project."
}
extern_lib_make_gen_body() {
  pushd ../test/extern_lib
  #-------------- 
  # Make variant 
  #-------------- 
  setup_example "extern_lib" "make"
...
atf_init_test_cases() {
    atf_add_test_case extern_lib_jam_gen
    atf_add_test_case extern_lib_boost_gen
    atf_add_test_case extern_lib_cmake_gen
    atf_add_test_case extern_lib_make_gen
}
