...
{
//{
//  pathcmp lhs_( this->absPath() );
//  pathcmp rhs_( a_other.absPath() );
//  BUTTER_REQUIRE( lhs_.leaf_at( 0 ) == rhs_.leaf_at( 0 ), "No common path possible on directories on different root devices." );
...
//}
//{
const QString lhs_ = this->absPath();
